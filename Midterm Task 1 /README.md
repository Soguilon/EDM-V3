## Midterm Lab Task 1
This portfolio demonstrates the process of [data normalization and cleaning](https://github.com/user-attachments/files/19071685/Midterm.Lab.Task.1.xlsx) applied to a transactional database. The dataset consists of multiple related tables, each designed to improve data organization and eliminate redundancy.
